...
const FilterBar = () => {
  return (
    <div className="mt-6 w-full rounded-lg   bg-white p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-3 border border-solid border-[var(--border-color)]">
      {/* User Select */}
